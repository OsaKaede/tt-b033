...
public class Cedula513xls {
    public static void main(String[] args) {
       
    }
    
    public String GenerarCedulaxls(Cedula513 obj3){
        ...
        String op8 = "";
        String op9 = "";
        op1 = obj3.getRespSuficiencia();
        op2 = obj3.getRespFuncionalidad();
        op3 = obj3.getRespSeguridad();
        op4 = obj3.getRespAislaRui();
        op5 = obj3.getRespMobiliario();
        op6 = obj3.getRespAccesibi();
        op7 = obj3.getRespConect();
        op8 = obj3.getRespHigiene();
        op9 = obj3.getRespEquipoAudio();
        Laboratorio = obj3.getLabOTaller();
        //ESCRIBE EL NOMBRE DEL LAB
        Row nlab = sheet.getRow(1);
        Cell nlabc = nlab.createCell(1);
        nlabc.setCellValue(Laboratorio); 
        //ESCRIBIR RespSuficiencia en row4, value = Si celda 2 , value = No celda 4
        Row sufi = sheet.getRow(4);
        CellReference cellReference = new CellReference("C5 || E5"); 
        Cell cell = sufi.getCell(cellReference.getCol()); 
        Cell sufic = sufi.getCell(2);
        sufic.setCellValue(op1);
        
        //escribir la opc2 RespFuncionalidad en row7, celda 2 o celda 4
